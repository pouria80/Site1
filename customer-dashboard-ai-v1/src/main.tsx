...
function App() {
  ...
  return (
    <div className={'app ' + (open ? 'open' : 'closed') + (focus ? ' focus-mode' : '')}>
      <aside className="side">
        ...
        <div className="side-footer-note">
          <Zap size={13} />
          <span>POORITEL ENGINE · ONLINE</span>
        </div>

        <div className="user-mini">
          <div className="avatar">P</div>
          <div className="user-copy"><b>Pouria</b><span>customer@example.com</span></div>
        </div>
      </aside>
      ...
      <main>
        <header>
          ...
          <div className="header-actions">
            <button className="icon-btn" onClick={() => setFocus(v => !v)} title="Focus mode"><Activity /></button>
        ...
        <section className="hero">
          <img className="hero-art" src="./src/assets/gaming-atmosphere.svg" alt="" aria-hidden="true" />
        ...
        <section className="mini-grid">
          <div className="mini-card compact-balance">
            <div className="mini-icon cyan"><WalletCards /></div>
            <div><span>AVAILABLE</span><b>{usd ? '$124.50' : '۱۲٬۴۵۰٬۰۰۰'}</b></div>
            <small>+ شارژ سریع</small>
          </div>
          <div className="mini-card">
            <div className="mini-icon purple"><ShoppingBag /></div>
            <div><span>ACTIVE ORDERS</span><b>03</b></div>
            <small>۱ مورد نیازمند بررسی</small>
          </div>
          <div className="mini-card">
            <div className="mini-icon green"><ShieldCheck /></div>
            <div><span>ACCOUNT HEALTH</span><b>92%</b></div>
            <small>امنیت مناسب</small>
          </div>
        </section>
        ...
        <section className="quick">
          ...
          <div className="quick-grid">
            ...
            <button className="qcard q2"><div className="qicon"><Minus /></div><div><b>برداشت</b><span>درخواست برداشت</span></div><ArrowUpRight /></button>
        ...
        <section className="grid">
          ...
          <div className="panel health">
            <div className="panel-head"><div><span className="eyebrow"><ShieldCheck /> ACCOUNT</span><h2>وضعیت حساب</h2></div></div>
            <div className="health-ring"><div><strong>92</strong><span>SECURE</span></div></div>
            <div className="health-list"><div><span className="ok" />ایمیل تأیید شده</div><div><span className="ok" />حساب فعال</div><div><span className="ok" />Session امن</div><div><span className="warn" />احراز هویت ناقص</div></div>
          </div>
        </section>
